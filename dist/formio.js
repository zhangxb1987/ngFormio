    ...
    fieldWrap: function(input) {
      ...
      var template =
        ...
        '<div ng-if="component.multiple"><table class="table table-bordered">' +
          ...
          '</tr>' +
          '<tr>' +
            '<td colspan="2"><a ng-click="addFieldValue()" class="btn btn-primary"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> {{ component.addAnother || "Add Another111" | formioTranslate:null:builder }}</a></td>' +
          '</tr>' +
        '</table></div>';
      return template;
    },
